...
AFRAME.registerComponent("markerhandler",{
    init:function(){
        ...
        this.el.addEventListener("markerFound",()=>{
            ...
            var city = document.querySelector(`#${model}-${barcodeValue}`);
        ...
        this.el.addEventListener("markerLost", () => {
            ...
            if (index > -1) {
              modelName.splice(index, 1); //The splice() method adds and/or removes array elements or overwrites the original array.
            }
        });
    },
    ...
    placeTheModel:function(modelName,models){
        var isListContainModel = this.isModelPresentInArray(modelsList,modelName);
